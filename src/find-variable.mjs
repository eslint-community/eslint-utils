 ...
 * @param {string | import('estree').Node | import('estree').Expression} nameOrNode The variable name to find. If this is a Node object then it should be an Identifier node.
